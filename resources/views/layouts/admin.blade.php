...
<script type="afaa6750a5b7890b844cdbc0-text/javascript">window.addEventListener('load', () => {
                ...
                <div class="peers ai-c fxw-nw">
                    <div class="peer peer-greed"><a class="sidebar-link td-n" href="index.html">
                            <div class="peers ai-c fxw-nw">
                                ...
                                <div class="peer peer-greed"><h5 class="lh-1 mB-0 logo-text">Darchula</h5></div>
                            </div>
                        </a></div>
                    <div class="peer">
            ...
            <ul class="sidebar-menu scrollable pos-r">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ url('languages') }}">languages</a></li>
                        <li><a class="sidebar-link" href="{{ url('education') }}">Education</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                                    ...
                                    <li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                            <div class="peer mR-15">
                                                @if(!empty($currentUser))
                                                    <img class="w-3r bdrs-50p" src="{{ $currentUser->profileImage() }}"
                                                ...
                                                <div class="peer peer-greed">
                                                    <div>
                                                        <div class="peers jc-sb fxw-nw mB-5">
                                                            <div class="peer"><p
                                                                        class="fw-500 mB-0">{{ !empty($currentUser) ? $currentUser->name() : '' }}</p>
                                                            </div>
                                                            <div class="peer">
                                                                <small class="fsz-xs">5 mins ago</small>
                                                            </div>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="afaa6750a5b7890b844cdbc0-|49" defer=""></script>
</body>
</html>
